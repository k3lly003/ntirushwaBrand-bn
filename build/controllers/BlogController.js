...
const blogModels_ts_1 = __importDefault(require("../models/blogModels.ts"));
const createBlog = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const newBlogData = req.body;
        const newBlog = new blogModels_ts_1.default(newBlogData);
        yield newBlog.save();
        res
            .status(201)
...
const readBlog = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const datafound = yield blogModels_ts_1.default.find({});
...
const updateBlog = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingBlog = yield blogModels_ts_1.default.findById(blogId);
        if (!existingBlog) {
            res.status(404).json({ message: "Blog not found", data: null });
        }
        else {
            const updatedBlog = yield blogModels_ts_1.default.findByIdAndUpdate({ _id: blogId }, { $set: updateInfo }, { new: true });
            res
                .status(200)
...
const deleteBlog = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const blogId = req.params.id;
        const deletedBlog = yield blogModels_ts_1.default.findByIdAndDelete(blogId);
        if (!deletedBlog) {
            res.status(404).json({ message: "Blog not found", data: null });
        }
        else {
